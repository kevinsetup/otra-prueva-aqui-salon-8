...
if [ $# == 0 ]; then
	...
	cd ~/home/alumno/Descargas/projects/website/ && git add $*
	
	# Esto nos pedira el mensaje del commit
	cd ~/home/alumno/Descargas/projects/website/ && git commit -m `date`

	# Y terminamos subiendo los archivos
	cd ~/home/alumno/Descargas/projects/website/ && git push origin master
